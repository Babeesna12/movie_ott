...
<body>
    <h1>Movie Search</h1>
    <form method="GET" action="<?php echo e(route('movies.search')); ?>">
        ...
        <ul>
            <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    ...
                    <form method="POST" action="<?php echo e(route('movies.addToFavorites', $movie['imdbID'])); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="title" value="<?php echo e($movie['Title']); ?>">
                        <input type="hidden" name="year" value="<?php echo e($movie['Year']); ?>">
                        <input type="hidden" name="poster" value="<?php echo e($movie['Poster']); ?>">
...
<?php /**PATH C:\Users\HP\Downloads\Babeesna\myapp\resources\views/movies/search.blade.php ENDPATH**/ ?>